...
def split_feature_file(input_file, train_ratio):
    ...
    # Print the summary
    print("Feature file split into training and testing sets.")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_ratio', type=float, default=0.7, help='Ratio of instances to use for training (default: 0.8)')
    # Parse the arguments
